...
HD_PWD='C:/Users/Zheng/Documents/GitHub/SED-Trabajo-VHDL/Trabajo/Trabajo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RELOJ_AJEDREZ.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RELOJ_AJEDREZ.tcl
