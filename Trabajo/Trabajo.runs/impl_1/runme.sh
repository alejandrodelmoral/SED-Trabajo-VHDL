...
HD_PWD='C:/Users/Zheng/Documents/GitHub/SED-Trabajo-VHDL/Trabajo/Trabajo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RELOJ_AJEDREZ.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RELOJ_AJEDREZ.tcl -notrace
